...
model = pickle.load(open('FinalDCT.pkl','rb'))
...
predict_val = model.predict([['path_token_count', 'average_domain_token', 'entropy_url', 'charcompvowels', 'charcompace', 'path_url_ratio', 'domain_url_ratio', 'symbol_count_url']])
